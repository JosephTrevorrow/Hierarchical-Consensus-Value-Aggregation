...
def aggregate_all_p(P_list, J_list, w):
    """
    This function is used by the -pv argument to aggregate on principles in solve.py
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-f',
        type=str,
        default="data/results/22-01-2025-agent-data.csv",
    ...
    parser.add_argument(
        '-pf',
        type=str,
        default="data/results/principle_test_cases/12-01-2025-principles.csv",
    ...
    parser.add_argument(
        '-smlf',
        type=str,
        default="data/results/means_and_salas_molina_ps/principles_for_slm.csv",
        help='CSV file with data for Salas-Molina method'
    )
    parser.add_argument(
        '-sml',
        type=bool,
    ...
    # Complete aggregation using the Salas-Molina et al method described in the paper. Code has been modified from: 
    if args.sml:
        file_path = args.smlf
        try:
        ...
        consensus_df.to_csv('/data/results/means_and_salas_molina_ps/test_cons.csv', index=False)
    elif args.l:
        A, b = FormalisationMatrix(P_list, J_list, w, 1, args.v)
        cons_1, _, _, = L1(A, b)
        print('L1 =', cons_1)
    ...
    # Aggregate using principle values
        ...
        # Find the mean of all the P values as a comparison.
