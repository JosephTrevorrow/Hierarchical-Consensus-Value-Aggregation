...
if __name__ == '__main__':
    agent_data_path = "data/results//22-01-2025-agent-data.csv"
    agent_data_df = pd.read_csv(agent_data_path)
    agent_data_df.rename(columns={'rel': 'Rel-Nonrel', 'nonrel': 'Nonrel-Rel'}, inplace=True)

    consensus_data_path_pref = "data/results/single_example/22-01-2025-actions.csv"
    consensus_data_path_act = "data/results/22-01-2025-preferences.csv"
