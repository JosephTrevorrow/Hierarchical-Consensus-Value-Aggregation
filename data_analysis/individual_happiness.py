...
if __name__ == '__main__':
    individual_df = pd.read_spss("preprocessing/ESS/ESS8e02_3-subset.sav", convert_categoricals=False)
    individual_df = individual_df.dropna(subset=['imptrad', 'ipgdtim', 'basinc'])
    # NOTE: Filter individual_df to only include agents in AT
    ...
    individual_df.to_csv("data/results/all_individual_responses.csv", index=False)
